...
export const adminLoginSchema = z.object({
  username: z.string().min(6, { message: 'Username should be at least 6 characters long' }).regex(/^\S*$/, { message: 'Username should not contain white spaces'}).regex(/^[a-zA-Z0-9!@#$%&*_?]+$/, {
