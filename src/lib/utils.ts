...
export const validateAdminSignInSecret = (password: string) => {
  console.log("Comparing passwords ", process.env.ADMIN_SIGNIN_SECRET);
  return password === process.env.ADMIN_SIGNIN_SECRET;
};
