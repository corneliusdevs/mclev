...
const AdminLogin: FC = (props): React.ReactNode => {
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className={`flex justify-center p-4 mt-2 ${isUsernameAndPassFieldNotEmpty.username && isUsernameAndPassFieldNotEmpty.password ? "" : "pointer-events-none opacity-35"}`}>
              <AlertDialogComponent
                ...
                buttonClassname=""
                actionButtonClassName={`${httpStatus === 200 && "bg-primarycol hover:bg-primarycol"} ${httpStatus === 401 && "bg-red-400 hover:bg-red-500"} px-8 transform hover:scale-90`}
                buttonSize={"lg"}
                buttonText="Ok"
                actionText="Ok"
                description=""
